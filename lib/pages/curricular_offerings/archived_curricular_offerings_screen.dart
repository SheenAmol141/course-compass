...
import 'package:course_compass/pages/curricular_offerings/edit_curricular_offer_screen.dart';
...
class ArchivedCurricularOfferingsScreen extends StatefulWidget {
  const ArchivedCurricularOfferingsScreen({super.key});

  @override
  State<ArchivedCurricularOfferingsScreen> createState() =>
      _ArchivedCurricularOfferingsScreenState();
}

class _ArchivedCurricularOfferingsScreenState
    extends State<ArchivedCurricularOfferingsScreen> {
// DropdownMenuEntry(
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        const Material(child: ResponsiveMenu("")),
                  ));
            },
                ...
                child: SizedBox(
                  ...
                  child: DropdownButton<String>(
                    ...
                    hint: const Padding(
                      ...
                      child: Text("Select your Senior High School Strand"),
                    ),
                    // menuWidth: 300,
                          ...
                          child: StreamBuilder(
                            stream: currentCampus == "ALAMINOS CITY CAMPUS"
                                ...
                                : currentCampus == "ASINGAN CAMPUS"
                                    ? firestore
                                        .collection("curricular_offerings")
                                        .where("campus", isEqualTo: "asingan")
                                        .where("archived", isEqualTo: true)
                                        .snapshots()
                                                                    ...
                                                                    : currentCampus ==
                                                                        ...
                                                                        ? firestore
                                                                            .collection(
                                                                                "curricular_offerings")
                                                                            .where("campus",
                                                                                isEqualTo: "OPEN UNIVERSITY SYSTEMS")
                                                                        ...
                                                                        : currentCampus == "EXPANDED TERTIARY EDUCATION EQUIVALENCY AND ACCREDITATION PROGRAM (ETEEAP)"
                                                                            ...
                                                                            : firestore.collection("curricular_offerings").where("archived", isEqualTo: true).orderBy("time_added", descending: true).snapshots(),
                            builder: (context, snapshot) {
                              if (!snapshot.hasData) {
                                ...
                                for (int i = 0;
                                    ...
                                    i++) {
                                  courses.add(snapshot.data!.docs.toList()[i]);
                                }
                ...
                children: [
                  Row(
                    children: [
                      ...
                      //                   builder: (context) =>
                      //                       EditCurricularOfferingQuillScreen(
                      //                           doc: courses[index]),
                      //                 ));
                      //               },
                      //               child: const Icon(
